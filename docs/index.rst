...
.. code-block:: bash
   ...
   curl -LO https://github.com/devopsifyco/check-cli/releases/download/0.0.0/check-linux-amd64
   chmod +x check-linux-amd64
   ./check-linux-amd64 --help

.. code-block:: powershell

   Invoke-WebRequest -Uri "https://github.com/devopsifyco/check-cli/releases/download/0.0.0/check.exe" -OutFile "check.exe"
   .\check.exe --help
